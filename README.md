...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/py-rouge-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11657&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/py-rouge-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `py-rouge` can be installed with:

```
conda install py-rouge
```

It is possible to list all of the versions of `py-rouge` available on your platform with:
